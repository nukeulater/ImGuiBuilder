...
{
private:
	ImConsoleImpl(const ImConsoleImpl&) = delete;
	ImConsoleImpl(ImConsoleImpl&&) = delete;
	ImConsoleImpl operator=(ImConsoleImpl&) = delete;
...
public:
    ...
    static void Render(bool* b_open)
    {
        ...
        console->Draw(k_console_window_name, b_open);
    }
...
do { \
ImConsoleImpl::LogToTab(_console_tab_logs, \
